...
public class ModelExecutionServiceImpl implements ModelExecutionService {
    ...
    private Map<String, Object> executeTownshipAggregation(Long stepId, List<String> regionCodes, Map<String, Object> inputData) {
        ...
        for (String regionCode : regionCodes) {
            ...
            // derive township inputs from community when missing
            Map<String, Double> _derivedInputs = deriveTownshipInputsFromCommunity(communityContext);
            for (Map.Entry<String, Double> _e : _derivedInputs.entrySet()) {
    ...
    // derive 9 township inputs from community context when missing
