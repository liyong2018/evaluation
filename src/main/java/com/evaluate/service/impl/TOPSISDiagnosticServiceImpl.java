...
import com.evaluate.service.UnifiedTOPSISCalculator.IdealSolution;
...
public class TOPSISDiagnosticServiceImpl implements TOPSISDiagnosticService {
    ...
    public TOPSISDiagnosticReport diagnoseWeightedData(
        ...
        // 4. 分析理想解计算
        analyzeIdealSolutions(weightedData, issues, recommendations);
    ...
    public Map<String, Object> generateCalculationLog(
        ...
        try {
            IdealSolution idealSolution = topsisCalculator.calculateIdealSolutions(weightedData, null);
